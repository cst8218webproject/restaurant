  ...
  <body>
    <div class="container">
     ...
     <form method="post" action="registration.jsp" class="form-signin">
        ...
        <input type="text" name="fname" value="" class="form-control" placeholder="First Name" required autofocus>
        <label for="inputEmail" class="sr-only">Last Name</label>
        <input type="text" name="lname" value="" class="form-control" placeholder="Last Name" required>
        <label for="inputPassword" class="sr-only">Email</label>
        <input type="email" name="email" value="" class="form-control" placeholder="Email" required>
        <label for="inputaddress" class="sr-only">User Name</label>
        <input type="text" name="uname" value="" class="form-control" placeholder="User Name" required><span class="status"></span>
