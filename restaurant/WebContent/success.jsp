	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="index.jsp" class="smoothScroll">LOG IN</a></li>
				<li><a href="reg.jsp" class="smoothScroll">REGISTER</a></li>
				<li><a href="welcome.jsp" class="smoothScroll">ORDER</a></li>
		...
		<div class="row">
			<div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
				...
				<div class="address">
					...
					<h4>LOCATION 1385 Woodroffe Ave, Nepean, ON K2G 1V8</h4>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
...
<section id="copyright">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<h3>ACZ Restaurant</h3>
				<p>Copyright © ACZ Restaurant 
