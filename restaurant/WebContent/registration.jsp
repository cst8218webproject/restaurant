...
<%
    ...
    try{
    	...
    	int i = st.executeUpdate("insert into users(username, email, firstname, lastname, password, Role_id, create_date) values ('" + user + "','" + email + "','" + fname + "','" + lname + "','" + pwd + "','" + '2' + "', current_date())");
    	if (i > 0) {
